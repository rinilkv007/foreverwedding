...
const PrivacyPolicy = () => {
    return (
        <div id='PrivacyPolicy'>
            ...
            <div className="container-policy  p-4">
                <h1 className="text-4xl font-bold mb-8">Privacy Policy</h1>

                <p>
                    Forever Wedding has made ForeverWedding.com website. This page is used to inform visitors regarding our policies with the
                    ...
                    same meanings as in our Terms and Conditions, which is accessible at Forever Wedding unless otherwise defined in this
                    Privacy Policy.
                </p>

                <h2 className="text-2xl font-bold my-6">Information Collection and Use</h2>

                <p>
                    For a better experience, while using our Service, we may require you to provide us with certain personally
                    identifiable information, including but not limited to Phone number. The information that we request will be
                    retained by us and used as described in this privacy policy. The app does use third party services that may
                    collect information used to identify you. Link to privacy policy of third party service providers used by the app
                    Google Play Services.
                </p>

                <h2 className="text-2xl font-bold my-6">Log Data</h2>
                <p>We want to inform you that whenever you use our Service, in a case of an error in the app we collect data and information (through third party products) on your phone called Log Data. This Log Data may include information such as your device Internet Protocol ("IP") address, device name, operating system version, the configuration of the app when utilizing our Service, the time and date of your use of the Service, and other statistics.</p>

                <h2 className="text-2xl font-bold my-6">Cookies</h2>
                ...
                <h2 className="text-2xl font-bold my-6">Service Providers</h2>
                ...
                <h2 className="text-2xl font-bold my-6">Links to Other Sites</h2>
                <p>This Service may contain links to other sites. If you click on a third-party link, you will be directed to that site. Note that these external sites are not operated by us. Therefore, we strongly advise you to review the Privacy Policy of these websites. We have no control over and assume no responsibility for the content, privacy policies, or practices of any third-party sites or services.</p>

                <h2 className="text-2xl font-bold my-6">Children’s Privacy</h2>
